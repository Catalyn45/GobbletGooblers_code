...
int sunet=0;
int minutes;
SDL_Rect singlepTextbox;
SDL_Texture* singlepTextTexture;
SDL_Rect singlepTextRect;
SDL_Rect uparrowsg;
SDL_Rect downarrowsg;
...
SDL_Texture* soundicon;
SDL_Texture* muteicon;
SDL_Rect soundiconRect;
SDL_Rect ro_langRect;
bool mute=false;
bool pressing=false;
Mix_Chunk* soundEffect;
SDL_Texture* volumeblank;
SDL_Texture* volumeorange;
SDL_Rect volumeblankRect;
SDL_Rect volumeorangeRect;
SDL_Texture* fr_lang;
